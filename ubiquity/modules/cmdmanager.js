...
CommandManager.prototype = {
  ...
  refresh: function CM_refresh() {
    if (this.__dynaLoad) {
      let {languageCode} = UbiquitySetup;
      if (this.__parserType !== (this.__parserType = languageCode)) {
        if (this.__nlParser) {
          this.__nlParser = null;
          this.__cmdSource.refresh(true);
        }
        this.__nlParser = NLParser.makeParserForLanguage(
                            languageCode, this.__cmdSource.getAllCommands());
        var refreshed = true;
      }
    }
  ...
  get parser   () { return this.__nlParser  },
  get lastInput() { return this.__lastInput },
  get previewer() { return this.__previewer },

  get maxSuggestions() { return CommandManager.maxSuggestions },
  get hasSuggestions() { return this.__activeQuery.hasResults },

  get suggestions() { return this.__activeQuery.suggestionList },
  get hilitedSuggestion() {
    return this.__activeQuery.suggestionList[this.__hilitedIndex]
  },
  get hilitedIndex( ) { return this.__hilitedIndex     },
  set hilitedIndex(i) { return this.__hilitedIndex = i },
};
