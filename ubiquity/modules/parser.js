...
var EXPORTED_SYMBOLS = ["NLParser", "ParserRegistry"];

var NLParser = {}
for (let name in this) if (typeof this[name] == "function")
  NLParser[name] = this[name]

const Cu = Components.utils
    , FLAG_DEFAULT = 1
    , PLUGINS = {__proto__: null}
    , {push} = []

Cu.import("resource://ubiquity/modules/utils.js");
Cu.import("resource://ubiquity/modules/suggestion_memory.js");
Cu.import("resource://ubiquity/modules/parser/locale_en.js");
Cu.import("resource://ubiquity/modules/msgservice.js");

var ParserRegistry = JSON.parse(
  Utils.getLocalUrl("resource://ubiquity/modules/parser/registry.json", "UTF-8")
)
...
function makeParserForLanguage(languageCode, verbList,
  ...
  if (!plugin) {
    ...
    let parser = ParserRegistry[languageCode]
    if (!parser)
      parser = ParserRegistry['en']
...
ParserQuery.prototype = {
  ...
  get hasResults() { return !!this._suggestionList.length},
...
Parser.prototype = {
  ...
  function P__nounFirstSuggestions(selObj, maxSuggestions, query) {
    ...
    return [for (v of verbs)
      new PartiallyParsedSentence(v, {__proto__: null}, selObj, 0, query)];
  },
...
ParsedSentence.prototype = {
  ...
  get icon() { return this._verb.cmd.icon },
  get previewUrl() { return this._verb.cmd.previewUrl },
  get previewDelay() { return this._verb.cmd.previewDelay },
...
PartiallyParsedSentence.prototype = {
  ...
  copy: function PPS_copy() {
    ...
    newPPS._parsedSentences =
      [for (ps of this._parsedSentences) ps.copy()];
  ...
  get fromNounFirstSuggestion() { return !this._matchScore },
};
...
Verb.prototype = {
  get name() { return this.cmd.names[0] },
  get icon() { return this.cmd.icon },
  get disabled() { return this.cmd.disabled },
