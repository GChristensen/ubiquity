...
var FEED_SRC_ANNO          = "ubiquity/source";
var FEED_TYPE_ANNO         = "ubiquity/type";
var FEED_AUTOUPDATE_ANNO   = "ubiquity/autoupdate";
var FEED_BUILTIN_ANNO      = "ubiquity/builtin";
var FEED_SUBSCRIBED_ANNO   = "ubiquity/confirmed";
var FEED_UNSUBSCRIBED_ANNO = "ubiquity/removed";
var FEED_SRC_URL_ANNO      = "ubiquity/commands";
var FEED_URL_ANNO          = "ubiquity/url";
var FEED_TITLE_ANNO        = "ubiquity/title";
var FEED_DATE_ANNO         = "ubiquity/date";
var FEED_BIN_ANNO          = "ubiquity/bin";

const FEED_ANNOS = Object.keys(this).filter(v => /^FEED_\w+_ANNO$/.test(v));
...
FMgrProto.isSubscribedFeed = function FMgr_isSubscribedFeed(uri) {
  return this._annSvc.pageHasAnnotation(Utils.uri(uri), FEED_SUBSCRIBED_ANNO)
}
...
FMgrProto.isUnsubscribedFeed = function FMgr_isUnsubscribedFeed(uri) {
  return this._annSvc.pageHasAnnotation(Utils.uri(uri), FEED_UNSUBSCRIBED_ANNO)
}
...
Feed.prototype = {
  ...
  get isBuiltIn() {
    return this._annSvc.pageHasAnnotation(this.uri, FEED_BUILTIN_ANNO)
  },

  // === {{{Feed#isSubscribed}}} ===
  // Whether the feed is currently being subscribed to or not. Read-only.
  get isSubscribed() {
    return this._annSvc.pageHasAnnotation(this.uri, FEED_SUBSCRIBED_ANNO)
  },
  ...
  get canAutoUpdate() {
    return this._annSvc.getPageAnnotation(this.uri, FEED_AUTOUPDATE_ANNO, "")
       === "true"
  },
  ...
  getCode: function Feed_getCode() {
    return this._annSvc.getPageAnnotation(this.uri, FEED_SRC_ANNO, "")
  },
