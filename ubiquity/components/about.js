...
XPCOMUtils.defineLazyGetter(this, "newChannel", () =>
...
UbiquityAboutHandler.prototype = {
  ...
  getURIFlags(uri) { return Ci.nsIAboutModule.ALLOW_SCRIPT },
};

this.NSGetFactory = XPCOMUtils.generateNSGetFactory([UbiquityAboutHandler]);
